              ...
              <div>
                ...
                <div className="space-y-2">
                  {programs.slice(0, 3).map((program) => (
                    <div key={program.id} className="p-2 bg-muted rounded text-sm">
              ...
              {isAdmin && (
                <>
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => navigate(`/add-program?category=${category.id}`)}
                  >
                  ...
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => navigate(`/add-sub-project?category=${category.id}`)}
                  >
                    <Plus className="h-4 w-4 mr-1" />
                    Sub-project
                  </Button>
